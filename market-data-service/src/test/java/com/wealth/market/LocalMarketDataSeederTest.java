...
class LocalMarketDataSeederTest {
    ...
    private LocalMarketDataSeeder seeder(boolean enabled, String fixturePath) {
        ...
        var s = new LocalMarketDataSeeder(assetPriceRepository, marketPriceService, objectMapper, props);
    ...
    // -------------------------------------------------------------------------
    @Test
    void run_seedsAllAssets_whenDatabaseIsEmpty() throws Exception {
    ...
    // -------------------------------------------------------------------------
    @Test
    void run_skipsExistingTickers_whenAlreadyPresent() throws Exception {
    ...
    // -------------------------------------------------------------------------
    @Test
    void run_seedsOnlyMissingTickers_whenPartiallySeeded() throws Exception {
        var test1 = new AssetPrice("TEST1", new BigDecimal("100.0"));
    ...
    // -------------------------------------------------------------------------
    @Test
    void run_doesNothing_whenDisabled() throws Exception {
    ...
    void run_logsErrorAndContinues_whenFixtureFileMissing() {
        assertThatNoException().isThrownBy(() ->
                seeder(true, MISSING_FIXTURE).run(null));
    ...
    // -------------------------------------------------------------------------
    @Test
    void run_parsesFixtureCorrectly() throws Exception {
