...
// History-append tests use synthetic, non-catalog tickers (e.g. "HIT_APPEND", "HIT_DEDUP") —
// catalog membership isn't the concern here (see SupportedAssetValidatorTest /
