-- =============================================================================
-- V8: Better Auth schema for PostgreSQL
--
-- Source: frontend/scripts/better-auth-schema.sql
-- Bugfix spec: .kiro/specs/better-auth-signin-fix/
--
-- Creates the four tables required by Better Auth (ba_user, ba_session,
-- ba_account, ba_verification) plus their indexes. All statements use
-- IF NOT EXISTS for idempotency — safe to re-run on databases where the
-- tables already exist.
--
-- This migration only ADDS new tables. It does NOT modify any existing
