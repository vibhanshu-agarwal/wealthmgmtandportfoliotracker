...
module "compute" {
  ...
  portfolio_image_uri         = var.portfolio_image_uri
  market_data_image_uri       = var.market_data_image_uri
  insight_image_uri           = var.insight_image_uri
  ...
  lambda_architecture            = coalesce(var.lambda_architecture, "arm64")
