...
export class ComputeStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: ComputeStackProps) {
    ...
    apiGatewayTaskDefinition.addContainer('ApiGatewayContainer', {
      ...
      environment: {
        SPRING_PROFILES_ACTIVE: 'aws',
        SPRING_DATA_REDIS_HOST: props.redisEndpointAddress,
        SPRING_DATA_REDIS_PORT: props.redisEndpointPort,
        SPRING_DATA_REDIS_SSL_ENABLED: 'false',
        SPRING_DATA_REDIS_LETTUCE_CLUSTER_REFRESH_ADAPTIVE_TOPOLOGY_REFRESH: 'false',
        SPRING_DATA_REDIS_LETTUCE_CLUSTER_REFRESH_PERIOD: '0',
        SPRING_DATA_REDIS_LETTUCE_SHUTDOWN_TIMEOUT: '200ms',
        SPRING_DATA_REDIS_LETTUCE_SHUTDOWN_GRACE_PERIOD: '100ms',
      },
