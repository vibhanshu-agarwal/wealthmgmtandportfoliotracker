...
- Name: dashboard-data.spec.ts >> Dashboard Data Integration Diagnostics >> 4. API Gateway responds 200 (not 401/403/CORS) for authenticated requests
- Location: tests\e2e\dashboard-data.spec.ts:201:7
