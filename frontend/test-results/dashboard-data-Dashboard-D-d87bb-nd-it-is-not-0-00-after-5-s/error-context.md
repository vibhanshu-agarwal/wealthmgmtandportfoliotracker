...
- Name: dashboard-data.spec.ts >> Dashboard Data Integration Diagnostics >> 2. /portfolio renders total-value and it is not $0.00 after 5 s
- Location: tests\e2e\dashboard-data.spec.ts:137:7
