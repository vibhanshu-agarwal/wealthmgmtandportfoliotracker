...
2. deployment_mode must be consistent with services/prebuilt_digest. Replaces silent
   ...
   silently doing something other than what was intended.
...
against disagreeing with the inputs it's paired with.
"""
