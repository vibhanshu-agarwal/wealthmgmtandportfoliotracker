...
retaining the independent `portfolio-service--0000096` attestation. The verifier must receive that
current packet through `--deployment-provenance` and still requires both exact serving digest and
revision matches before any mutation can arm.
...
[2026-09-10 rehearsal record](../evidence/b2-task-8-9/rehearsal-20260910.json).
