...
pending independent review** of the authorized three-caller public Azure synthetic
([run 33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
from `main@f66d7ab6a4db1a327fd030ba9897bfc431104945`). That live run succeeded with all three
`[b1-g5]` markers; Task **5.7 stays unchecked** until review accepts the evidence. Unattended
synthetics remain suspended in `synthetic-monitoring.yml`. See
...
| **D — Demo credibility** | Canonical prices refreshed and reconciled; demo initializer exists; authorized 9.12 retry activated the Active_Asset set | Demo portfolio still holds 159 holdings after the 9.13 scale restore on `portfolio-service--0000092`, with both flags `false`; historical pooled-session setter remains unidentified | 9.14 and the custom-domain restore are complete; keep B1 G5 / Task 5.7 open pending independent review of run 33411410271, and do not treat operational 9.12 success as historical RCA closure |
...
| Version-bearing portfolio read | ✅ G2a/R-B2 green on `portfolio-service--0000081` / `sha256:d544649f…`; caller migration 5.4–5.6 on `main@0b5d60d1` (source-only, not deployed); **5.7/G5 open pending independent review** of run [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271) (Task 5.7 unchecked) |
...
- Custom domain: **restored.** `api.vibhanshu-ai-portfolio.dev` has the exact `SniEnabled` binding
  ...
  has now run successfully, and Task 5.7 stays unchecked pending independent review; unattended
  synthetics remain suspended in `synthetic-monitoring.yml`; backlog item
...
- B1 G5 / Task 5.7 remain open — PR #194 reviewed restoration evidence; authorized three-caller
  run [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
  succeeded from `main@f66d7ab6` with all three markers; Task 5.7 stays unchecked pending
  independent review. Unattended synthetics remain suspended in `synthetic-monitoring.yml`.
...
| 5 — version-bearing read | 🟡 Tasks 5.1–5.3 / R-B2 complete; **5.4–5.6 merged on `main@0b5d60d1`** (PR #161, source-only); **5.7/G5 open pending independent review** of authorized three-caller run [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271) (`main@f66d7ab6`; Task 5.7 unchecked) | Task 5.1 on main@f22e2ff; G2a/R-B2 green on portfolio-service--0000081 / sha256:d544649f…; caller migration merged source-only; historical G5 runs 33046987880 / 33047168136 failed at TLS login before seed; post-restore three-caller markers recorded in [`B1_G5_INGRESS_BLOCKER.md`](../runbooks/B1_G5_INGRESS_BLOCKER.md) |
...
remains incomplete (checkbox unchecked)** pending independent review of authorized public Azure
synthetic [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
from `main@f66d7ab6a4db1a327fd030ba9897bfc431104945` (all three `[b1-g5]` markers observed).
...
| `cursor/b1-wave5b-seed-caller-migration` / PR #161 | **Merged source-only on `main@0b5d60d1`** — Tasks 5.4–5.6; **5.7/G5 incomplete (unchecked)** — historical runs 33046987880 / 33047168136 failed pre-restore; authorized post-restore three-caller run [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271) succeeded from `main@f66d7ab6` with all three markers; evidence pending independent review ([`B1_G5_INGRESS_BLOCKER.md`](../runbooks/B1_G5_INGRESS_BLOCKER.md)) | No deploy by this evidence PR; Task 5.7 unchecked; Wave 6/R-B3 still gated pending review |
...
- 9.14 is complete and live-verified; **B1 G5 / Task 5.7 remain open** pending independent review of
  authorized three-caller run [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
...
1. **Operational lane:** Spec A's production cutover is **complete through 9.14**. The plan was
   ...
   connections still disabled
    ...
    Authorized three-caller synthetic
    [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
    succeeded from `main@f66d7ab6`; Task 5.7 remains unchecked pending independent review; unattended
    synthetics remain suspended in `synthetic-monitoring.yml`. Three further process follow-ups are filed alongside it:
   [`service-version-image-drift`](../todos/backlog/service-version-image-drift/README.md),
...
source-only on `main@0b5d60d1`** (PR #161); **5.7/G5 remains unchecked** pending independent review
  of authorized three-caller public Azure synthetic
  [33411410271](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/actions/runs/33411410271)
  from `main@f66d7ab6` (all three `[b1-g5]` markers observed; holdings-only seed; no market-data
  writer). Waves 6–7 and candidate packaging (7.5/R-C) remain separately gated. Do not claim
