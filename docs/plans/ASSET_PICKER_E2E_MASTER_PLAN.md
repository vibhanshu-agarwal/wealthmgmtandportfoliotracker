...
were already settled in a prior brainstorm but never formalized, then corrected across twenty-three
review passes — twenty-two by Codex adversarial review, plus one internal parallel-agent audit
...
- **`.kiro/specs/asset-picker-composition/requirements.md` and `design.md`** now exist — Revision
  2 (twenty-three review passes as of 2026-08-22 — twenty-two Codex, one internal Claude audit), synthesized from decisions already settled in
