...
were already settled in a prior brainstorm but never formalized, then corrected across twenty-six
review passes — twenty-four by Codex adversarial review, plus two internal parallel-agent audits
...
- **`.kiro/specs/asset-picker-composition/requirements.md` and `design.md`** now exist — Revision
  2 (twenty-six review passes as of 2026-08-22 — twenty-four Codex, two internal Claude audits), synthesized from decisions already settled in
