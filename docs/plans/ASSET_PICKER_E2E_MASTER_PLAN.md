...
B2 Wave 1 (Tasks 1.1-1.19) and Wave 2 Tasks 2.1-2.5 are merged source-only through PR #178 at `main@38e3d95`; they remain entirely mock-backed and disabled by default. Wave 3 presence source Tasks 3.1–3.6 merged source-only via PR #179 at `main@cc97a209`; Task 3.7 deploy/live proof remains open (not deployed, not activated, not live-probed). Wave 4 Tasks 4.1–4.4a merged source-only via PR #180 at `main@63fc058`; they are not deployed, routed, or user-visible. Task 5.1a merged source-only via PR #202 at `main@64761dc2`; Task 5.1b is **implemented but unmerged** on `feat/b2-task-5-1b-replica-token-provider` (not deployed); Wave 8 Tasks 8.1 and 8.2a merged source-only via PRs #185 and #203 at `main@198c878d` and `main@addd8049`. None is deployed. Tasks 2.6–2.7, 3.7, 4.5, the remaining Wave 5 and Wave 8 work, and Waves 6, 9, and 10 remain open; Wave 7 is informational.
...
| **C — B2 Asset Picker product** | Requirements, design, task plan, five-screen visual mockup, Wave 1 / partial Wave 2 frontend source, Wave 3 presence source, Wave 4 demo-reset source, and additional source Tasks 5.1a, 5.1b, 8.1, and 8.2a | Wave 1 (1.1-1.19) + Wave 2 Tasks 2.1-2.5 merged source-only on `main@38e3d95` via PR #178; Wave 3 Tasks 3.1–3.6 merged source-only on `main@cc97a209` via PR #179; Wave 4 Tasks 4.1–4.4a merged source-only via PR #180 at `main@63fc058`; Task 5.1a merged via PR #202 at `main@64761dc2`; Task 5.1b **implemented but unmerged** on `feat/b2-task-5-1b-replica-token-provider`; Tasks 8.1 and 8.2a merged via PRs #185 and #203 at `main@198c878d` and `main@addd8049`. All remain undeployed | Task 3.7 deploy/live proof; Task 4.5; Task 5.1 and remaining Wave 5 and Wave 8 bundles; live integration and exposure remain separately gated |
...
| 5 — manual-reset gateway bundle | 🟡 Task 5.1a source merged via [PR #202](https://github.com/vibhanshu-agarwal/wealthmgmtandportfoliotracker/pull/202) / `main@64761dc2`; not deployed. Task 5.1b **implemented but unmerged** on `feat/b2-task-5-1b-replica-token-provider` (not deployed); the 5.1–5.6 deployable bundle remains gated on Wave 4 Task 4.5 | Internal-key provider, probe jar, Azure image smoke, and aggregate integration merged; replica-token provider/tool implemented but unmerged; filter/routes not started |
