...
| Version-bearing portfolio read | ❌ `PortfolioResponse.version` is on `main@2673f40` but authenticated serving proof is still Wave 5; authenticated serving proof is Wave 5 |
