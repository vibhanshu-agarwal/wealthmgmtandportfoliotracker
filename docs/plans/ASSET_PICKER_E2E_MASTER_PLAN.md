...
| 9 — live integration | 🟡 Tasks 9.1, 9.3, 9.4, 9.5 (PR #231 at `main@b4c68253b99a796d6301ef79b5aa5a47d5cbd962`), and 9.6 have their recorded source/local evidence. Tasks 9.2/9.7/9.8/9.9 are now locally source/assembled-stack complete: one disposable Compose real-browser run passed 5/5 across setup plus picker and demo-reset success/conflict; active CI wiring is local only | GitHub CI has not run this wiring. No deployment or Production E2E is claimed; B1 R-C deployment/convergence and Wave 10 still gate exposure |
