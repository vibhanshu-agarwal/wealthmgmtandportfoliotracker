...
| 2 — decimal adapter | 🟡 Task 2.7 audit drafted; independent B1 review pending | PR #178 / `main@38e3d95`; the [Task 2.7 audit](../evidence/b2-task-2-7/historical-containment-audit-20260910.md) records deployment containment but leaves user-visible impact unproven pending review; retain numeric compatibility |
