...
**Observed:** exit 0 — `Master-plan status propagation guard passed (14 changed paths)` against
`origin/main@1664bb8eb837af6300be39055e1dc5e7ff6fd662` and the branch tip at each local
guard run (including after this note). Re-resolve `HEAD` before publication.
