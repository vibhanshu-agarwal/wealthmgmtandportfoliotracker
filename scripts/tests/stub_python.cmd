...
if defined STUB_CAPTURE >>"%STUB_CAPTURE%" echo python-env TASK8_9_ACCESS_TOKEN=[%TASK8_9_ACCESS_TOKEN%] TASK8_9_DEMO_PASSWORD=[%TASK8_9_DEMO_PASSWORD%] WAVE9_STEP_A_PASSWORD=[%WAVE9_STEP_A_PASSWORD%]
