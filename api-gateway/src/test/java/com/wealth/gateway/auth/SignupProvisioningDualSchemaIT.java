...
/**
 * Dual-schema proof that gateway signup portfolio insertion remains compatible across V19 and V20.
 *
 * <p>The insert must not name V20-only columns. Against V20, database defaults must produce {@code
 * version = 0} and a non-null {@code updated_at}.
 */
@Tag("integration")
@Testcontainers
